...
class SystemDataStructureRootTest extends BaseTest {
    ...
    {
        $ietOriginalData = json_decode(file_get_contents(self::$mockDataIETPath), true);
        self::$systemDataStructureRoot->setRootArray(self::$mockDataIET);
        $result = self::$systemDataStructureRoot->getSingleChildNodeByName('notes');
        $expectedArray = $ietOriginalData[0];
        ...
        $expectedArray = $ietOriginalData[4]['structuredDataNodes']['structuredDataNode'][10]['structuredDataNodes']['structuredDataNode']['structuredDataNodes']['structuredDataNode'][25]['structuredDataNodes']['structuredDataNode'];
        ...
        $expectedArray = $ietOriginalData[3]['structuredDataNodes']['structuredDataNode'][10]['structuredDataNodes']['structuredDataNode'][1]['structuredDataNodes']['structuredDataNode'][25]['structuredDataNodes']['structuredDataNode'][0];
        $this->assertSame($expectedArray, $tableHeaderCellNode->getNodeArray());

        $tableHeaderCellNode = $sectionNode->getSingleDescendantNodeByPath('column/chunk/table-header/header-cell', 2);
        $expectedArray = $ietOriginalData[3]['structuredDataNodes']['structuredDataNode'][10]['structuredDataNodes']['structuredDataNode'][1]['structuredDataNodes']['structuredDataNode'][25]['structuredDataNodes']['structuredDataNode'][1];
        $this->assertSame($expectedArray, $tableHeaderCellNode->getNodeArray());

        $tableHeaderNode = $sectionNode->getSingleDescendantNodeByPath('column/chunk/table-header', 1);
        $expectedArray = $ietOriginalData[3]['structuredDataNodes']['structuredDataNode'][10]['structuredDataNodes']['structuredDataNode'][1]['structuredDataNodes']['structuredDataNode'][25];
